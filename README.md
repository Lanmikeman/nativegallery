...
> **Production** форка: **Ubuntu 24.04 + Nginx**. Альтернативы (Debian, Apache, Rocky/AlmaLinux/CentOS): [docs/deployment-alternatives.md](docs/deployment-alternatives.md).
...
| [docs/deployment-alternatives.md](docs/deployment-alternatives.md) | Debian, Apache, Rocky/CentOS — альтернативная установка |
