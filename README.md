...
> **Production** форка: **Ubuntu 24.04 + Nginx**. Альтернативы (Apache, Rocky/AlmaLinux/CentOS): [docs/deployment-alternatives.md](docs/deployment-alternatives.md).
...
**Автоустановка (Ubuntu/Debian + Apache + PHP-FPM):**
...
| [docs/deployment-alternatives.md](docs/deployment-alternatives.md) | Apache, Rocky/CentOS — альтернативная установка |
