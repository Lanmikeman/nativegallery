...
>
> Документация: [docs/](docs/) · История изменений: [CHANGELOG.md](CHANGELOG.md) · **Релиз 1.4:** [GitHub Releases](https://github.com/Lanmikeman/nativegallery/releases/tag/release-1.4)
