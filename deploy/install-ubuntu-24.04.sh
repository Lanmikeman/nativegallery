...
for sql_file in sqlcore/base.sql sqlcore/sql_0001.sql sqlcore/sql_0002.sql sqlcore/sql_0003.sql sqlcore/sql_0004.sql sqlcore/sql_0005.sql sqlcore/sql_0006.sql; do
    if [[ -f "$sql_file" ]]; then
