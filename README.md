...
> **Форк [Lanmikeman/nativegallery](https://github.com/Lanmikeman/nativegallery)** — Ubuntu 24.04 + Nginx, публичные разделы как на transphoto.org, поиск, страница обновлений, фотоконкурсы с cron, редактирование фото и заявки на изменение БД. См. [CHANGELOG.md](CHANGELOG.md).
