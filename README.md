...
> **Production** форка: **Ubuntu 24.04 + Nginx**, каталог **`/mnt/win/nativegallery`**. Пути по умолчанию в скриптах: **`/var/www/nativegallery`** — [paths.md](docs/paths.md). Альтернативы: [deployment-alternatives.md](docs/deployment-alternatives.md) · [windows-iis.md](docs/windows-iis.md) · [manual-install.md](docs/manual-install.md) · [docker.md](docs/docker.md).
...
| `NG_WEB_ROOT` | `/var/www/nativegallery` | Путь к проекту (production: `/mnt/win/nativegallery`) |
...
```bash
cd /mnt/win/nativegallery   # или /var/www/nativegallery — см. docs/paths.md
git pull
composer install --no-dev
...
| [docs/paths.md](docs/paths.md) | Пути по умолчанию и production (`/mnt/win/...`) |
