...
>
> Документация: [docs/](docs/) · История изменений: [CHANGELOG.md](CHANGELOG.md) · **Релиз 1.5:** [GitHub Releases](https://github.com/Lanmikeman/nativegallery/releases/tag/release-1.5) · [заметки](docs/releases/1.5.md) · [1.4](https://github.com/Lanmikeman/nativegallery/releases/tag/release-1.4)
...
- [x] **Вход через OpenVK** — [openvk.org](https://openvk.org) и [vepurovk.xyz](https://vepurovk.xyz) (второй инстанс OVK на production-сервере), привязка в `/lk/profile?type=OpenVK`
