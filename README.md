...
>
> Документация: [docs/](docs/) · История изменений: [CHANGELOG.md](CHANGELOG.md) · **Релиз 1.7:** [GitHub Releases](https://github.com/Lanmikeman/nativegallery/releases/tag/release-1.7) · [заметки](docs/releases/1.7.md) · [1.6](docs/releases/1.6.md) · [1.4](https://github.com/Lanmikeman/nativegallery/releases/tag/release-1.4)
...
Актуально для форка **v1.7** (ветка `main`). Подробный список изменений — [CHANGELOG.md](CHANGELOG.md).
...
- [x] **Музыка** — `/music`, мини-плеер в шапке, личные треки/потоки/плейлисты, M3U, ICY-метаданные радио (`sql_0010`)
- [x] **Общие радиостанции** — админка `/admin?type=RadioStations`, станции для всех пользователей (`sql_0011`)
- [x] **SPA-навигация** — переходы без перезагрузки, перелистывание фото (`/api/photo/move`)
- [x] **Развёртывание** — Ubuntu 24.04 + Nginx + PHP 8.3, `deploy/install-ubuntu-24.04.sh`, `deploy/nginx/nativegallery.conf`
- [x] **Документация** — `docs/configuration.md`, `docs/deployment.md`, `docs/routes.md`, `docs/releases/1.7.md`
...
- импортирует все SQL-миграции из `sqlcore/` (включая `sql_0006` … `sql_0011`);
...
3. Импортируйте SQL-миграции **в указанном порядке**:
   ...
   mysql ngallery < sqlcore/sql_0010.sql
   mysql ngallery < sqlcore/sql_0011.sql
   ```
...
| Радиостанции | `/admin?type=RadioStations` | Общие HTTP-потоки для всех пользователей на `/music` |
...
Подробнее: [docs/deployment.md](docs/deployment.md), [docs/releases/1.7.md](docs/releases/1.7.md).
...
| [docs/releases/1.7.md](docs/releases/1.7.md) | Заметки к релизу 1.7 |
