...
**Операционная система**: Ubuntu 20.04+ (рекомендуется **Ubuntu 24.04**) или Debian 12+ (bookworm/trixie)\
...
> **Production** форка: **Ubuntu 24.04 + Nginx**. Альтернативы: [deployment-alternatives.md](docs/deployment-alternatives.md) · Ручная установка: [manual-install.md](docs/manual-install.md) · Docker: [docker.md](docs/docker.md) · Pterodactyl: [pterodactyl.md](docs/pterodactyl.md).
